...
- fill the Https link for the package, in this case, 'https://github.com/tglGames-Plugins/tgl-service-locator.git'
- Add
The package will be added under 'TGL Service Locator' in packages, use as needed.
...
- add the name and version
	- name: `com.tglgames.tgl-service-locator`
